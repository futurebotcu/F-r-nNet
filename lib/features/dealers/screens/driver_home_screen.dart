...
import 'dealer_shell_screen.dart';

/// Bireysel şoför `/dealers` girişi (feat/driver-real-scoped-shell).
///
/// Ayrı "Şoför Paneli" reimplementation DEĞİL. Aktif şoförse normal
/// [DealerShellScreen]'i `ProviderScope` ile **driverScoped** modda render
/// eder → başlık "Bayi Yönetimi", alt nav Genel Bakış · Bayiler · Hareketler ·
/// Raporlar, data scope `DriverScopedDealerRepository` ile atanmış bayiler +
/// driver_id'ye daralır, owner-only CTA'lar gizlenir.
///
/// Henüz atanmamış (davet bekleyen / boş) şoför için davet kartı + boş durum
/// gösterilir (mevcut davranış korunur).
class DriverHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Aktif şoför: normal Bayi Yönetimi shell'i scoped modda.
    if (hasPanel) {
    ...
    // Henüz atanmamış: davet kartı (varsa) + boş durum.
