...
| ID | Title | Severity | Status | Source | Notes |
|---|---|---|---|---|---|
| P1.18 | Feed like toggle no try/catch | P1 | OPEN | `feed_screen.dart:351-367` | guest guard var ama network error UX yok |
| P1.19 | Feed save toggle no try/catch | P1 | OPEN | `feed_screen.dart:368-384` | aynı pattern |
