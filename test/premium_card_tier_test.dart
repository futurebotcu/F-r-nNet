...
void main() {
  group('PremiumCard — default standard tier', () {
    testWidgets('Default tier=standard → card bg + hairline border + card shadow',
        (tester) async {
      await tester.pumpWidget(_wrap(
        const PremiumCard(child: Text('x')),
      ));
  ...
  group('PremiumCard — tier=hero', () {
    ...
    testWidgets(
        ...
        (tester) async {
      await tester.pumpWidget(_wrap(
        const PremiumCard(warm: true, child: Text('x')),
      ));
      final deco = _decorationOf(tester);
      expect(deco.color, AppColors.elevatedCard);
      expect(deco.boxShadow, AppShadow.heroGlow);
  ...
  group('PremiumCard — tier=compact', () {
    testWidgets(
        ...
        (tester) async {
      await tester.pumpWidget(_wrap(
        const PremiumCard(tier: CardTier.compact, child: Text('x')),
      ));
      final deco = _decorationOf(tester);
      expect(deco.color, AppColors.card);
